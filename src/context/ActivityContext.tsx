...
import { ActivityActions, activityReducer, initialState } from "../components/reducers/activity-reducer"
...
export const ActivityProvider = ({children}: ActivityProviderProps) => {
    ...
    const emptyActivities = useMemo(()=> state.activities.length === 0, [state.activities])
